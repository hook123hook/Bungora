...
const WALLET_NAME = 'Bungora-watch';
...
console.log('==============================================================');
console.log(' Bungora — view-only cüzdan üretici (monero-wallet-rpc tabanlı)');
...
console.log('');
console.log('[OK] Bungora-watch.keys hazır (view-only).');
console.log('');
